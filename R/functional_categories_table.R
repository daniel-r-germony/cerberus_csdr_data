...
functional_categories_with_clin_table <- functional_categories_table %>%
    mutate(CLIN_Name = case_when(
        ID == "11-1000" ~ "Systems Engineering & Systems Engineering", # Top Executives
        ID == "11-2000" ~ "Systems Engineering & Systems Engineering", # Advertising, Marketing, Promotions, Public Relations, and Sales Managers
        ID == "11-3000" ~ NA_character_, # Operations Specialties Managers
        ID == "11-9000" ~ "Systems Engineering & Systems Engineering", # Other Management Occupations
        ID == "13-1000" ~ "Systems Engineering & Systems Engineering", # Business Operations Specialists
        ID == "13-2000" ~ "Systems Engineering & Systems Engineering", # Financial Specialists
        ID == "15-1100" ~ NA_character_, # Computer Occupations
        ID == "15-2000" ~ "Systems Engineering & Systems Engineering", # Mathematical Science Occupations
        ID == "17-1000" ~ NA_character_, # Architects, Surveyors, and Cartographers
        ID == "17-2000" ~ NA_character_, # Engineers
        ID == "17-3000" ~ NA_character_, # Drafters, Engineering Technicians, and Mapping Technicians
        ID == "19-1000" ~ NA_character_, # Life Scientists
        ID == "19-2000" ~ NA_character_, # Physical Scientists
        ID == "19-3000" ~ NA_character_, # Social Scientists and Related Workers
        ID == "19-4000" ~ NA_character_, # Life, Physical, and Social Science Technicians
        ...
        ID == "25-4000" ~ NA_character_, # Librarians, Curators, and Archivists
        ID == "25-9000" ~ NA_character_, # Other Education, Training, and Library Occupations
        ID == "27-1000" ~ NA_character_, # Art and Design Workers
        ID == "27-2000" ~ NA_character_, # Entertainers and Performers, Sports and Related Workers
        ID == "27-3000" ~ "Systems Engineering & Systems Engineering", # Media and Communication Workers
        ID == "27-4000" ~ "Systems Engineering & Systems Engineering", # Media and Communication Equipment Workers
        ID == "29-1000" ~ NA_character_, # Health Diagnosing and Treating Practitioners
        ID == "29-2000" ~ NA_character_, # Health Technologists and Technicians
        ID == "29-9000" ~ NA_character_, # Other Healthcare Practitioners and Technical Occupations
        ID == "31-1000" ~ NA_character_, # Nursing, Psychiatric, and Home Health Aides
        ID == "31-2000" ~ NA_character_, # Occupational Therapy and Physical Therapist Assistants and Aides
        ID == "31-9000" ~ NA_character_, # Other Healthcare Support Occupations
        ID == "33-1000" ~ NA_character_, # Supervisors of Protective Service Workers
        ID == "33-2000" ~ NA_character_, # Fire Fighting and Prevention Workers
        ID == "33-3000" ~ NA_character_, # Law Enforcement Workers
        ID == "33-9000" ~ NA_character_, # Other Protective Service Workers
        ...
        ID == "39-7000" ~ NA_character_, # Tour and Travel Guides
        ID == "39-9000" ~ NA_character_, # Other Personal Care and Service Workers
        ID == "41-1000" ~ NA_character_, # Supervisors of Sales Workers
        ID == "41-2000" ~ NA_character_, # Retail Sales Workers
        ID == "41-3000" ~ NA_character_, # Sales Representatives, Services
        ID == "41-4000" ~ NA_character_, # Sales Representatives, Wholesale and Manufacturing
        ID == "41-9000" ~ NA_character_, # Other Sales and Related Workers
        ID == "43-1000" ~ NA_character_, # Supervisors of Office and Administrative Support Workers
        ID == "43-2000" ~ NA_character_, # Communications Equipment Operators
        ID == "43-3000" ~ NA_character_, # Financial Clerks
        ID == "43-4000" ~ NA_character_, # Information and Record Clerks
        ID == "43-5000" ~ NA_character_, # Material Recording, Scheduling, Dispatching, and Distributing Workers
        ID == "43-6000" ~ NA_character_, # Secretaries and Administrative Assistants
        ID == "43-9000" ~ NA_character_, # Other Office and Administrative Support Workers
        ID == "45-1000" ~ NA_character_, # Supervisors of Farming, Fishing, and Forestry Workers
        ID == "45-2000" ~ NA_character_, # Agricultural Workers
        ID == "45-4000" ~ NA_character_, # Forest, Conservation, and Logging Workers
        ID == "47-1000" ~ NA_character_, # Supervisors of Construction and Extraction Workers
        ID == "47-2000" ~ NA_character_, # Construction Trades Workers
        ID == "47-3000" ~ NA_character_, # Helpers, Construction Trades
        ID == "47-4000" ~ NA_character_, # Other Construction and Related Workers
        ID == "47-5000" ~ NA_character_, # Extraction Workers
        ID == "49-1000" ~ "Test & Evaluation Support", # Supervisors of Installation, Maintenance, and Repair Workers
        ID == "49-2000" ~ "Test & Evaluation Support", # Electrical and Electronic Equipment Mechanics, Installers, and Repairers
        ID == "49-3000" ~ "Test & Evaluation Support", # Vehicle and Mobile Equipment Mechanics, Installers, and Repairers
        ID == "49-9000" ~ "Test & Evaluation Support", # Other Installation, Maintenance, and Repair Occupations
        ID == "51-1000" ~ NA_character_, # Supervisors of Production Workers
        ID == "51-2000" ~ NA_character_, # Assemblers and Fabricators
        ID == "51-3000" ~ NA_character_, # Food Processing Workers
        ID == "51-4000" ~ NA_character_, # Metal Workers and Plastic Workers
        ID == "51-5100" ~ NA_character_, # Printing Workers
        ID == "51-6000" ~ NA_character_, # Textile, Apparel, and Furnishings Workers
        ID == "51-7000" ~ NA_character_, # Woodworkers
        ID == "51-8000" ~ NA_character_, # Plant and System Operators
        ID == "51-9000" ~ NA_character_, # Other Production Occupations
        ID == "53-1000" ~ NA_character_, # Supervisors of Transportation and Material Moving Workers
        ID == "53-2000" ~ NA_character_, # Air Transportation Workers
        ID == "53-3000" ~ "Systems Engineering & Systems Engineering", # Motor Vehicle Operators
        ID == "53-4000" ~ NA_character_, # Rail Transportation Workers
        ID == "53-5000" ~ NA_character_, # Water Transportation Workers
        ID == "53-6000" ~ NA_character_, # Other Transportation Workers
        ID == "53-7000" ~ NA_character_, # Material Moving Workers
        TRUE ~ NA_character_))
